  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">ChainGuard - Escalation management tool for small business hierarchies</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Prevents employees from bypassing line managers by creating structured communication channels that route issues appropriately, protecting manager time while ensuring proper workflow in small businesses.

Target Customer: Small business owners and managers in hospitality, retail, and service industries with 10-100 employees

---
Category: Micro-SaaS
Target Market: Small business owners and managers in hospitality, retail, and service industries with 10-100 employees
Source Hypothesis ID: 6a9ed65a-a1a8-4a31-a1cc-b3575dd38949
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust ChainGuard - Escalation management tool for small business hierarchies.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} ChainGuard - Escalation management tool for small business hierarchies. All rights reserved.</p>
