  ...
  try {
    ...
    return new NextResponse(JSON.stringify(exportData, null, 2), {
      headers: {
        ...
        'Content-Disposition': `attachment; filename="ChainGuard - Escalation management tool for small business hierarchies-export-${new Date().toISOString().split('T')[0]}.json"`,
      },
    });
  } catch (error: any) {
