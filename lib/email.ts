...
const FROM = process.env.EMAIL_FROM || 'ChainGuard - Escalation management tool for small business hierarchies <noreply@example.com>';
const APP_NAME = 'ChainGuard - Escalation management tool for small business hierarchies';
